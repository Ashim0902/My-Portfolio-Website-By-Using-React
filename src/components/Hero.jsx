...
const Hero = () => {
  ...
  return (
    <section id="home" className="pt-16 min-h-screen flex items-center justify-center relative overflow-hidden bg-gray-900">
      {/* Background gradient */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fade-in-up">
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            ...
            Specializing in web development, photography, and video editing with hands-on experience 
            from multiple internships and workshops.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            ...
            <div className="flex items-center space-x-2 bg-gray-800/80 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg border border-orange-500/20">
              ...
              <span className="text-sm font-medium text-white">Photo/Video Editor</span>
            </div>
          </div>
